...
class Link implements Component
{
     ...
     * @param array  $params
     * @param bool   $absolute
     * @return \DevEngine\Core\UI\Widget\Link
     */
    public function add(string $name, string $route, array $params = [], bool $absolute = false): \DevEngine\Core\UI\Widget\Link
    {
        $link = new \DevEngine\Core\UI\Widget\Link($name, $route, $params, $absolute);
