...
use DevEngine\Core\Model\FormData;
...
class Form
{
     ...
     * 获取表单UI
     * @param $formId
     * @param \DevEngine\Core\UI\Form $form
     * @param int $id
     * @param string $hasType
     * @return \DevEngine\Core\UI\Form
     */
    public static function getFormUI($formId, \DevEngine\Core\UI\Form $form, int $id = 0, string $hasType = ''): \DevEngine\Core\UI\Form
    {
        $model = new \DevEngine\Core\Model\FormData();
        $info = [];
        if ($id) {
            if ($hasType) {
        ...
        $formInfo = \DevEngine\Core\Model\Form::find($formId);
    ...
    public static function formUI(): array
    {
        return [
            'text' => [
                'ui' => function ($config, \DevEngine\Core\UI\Form $form, $value) {
