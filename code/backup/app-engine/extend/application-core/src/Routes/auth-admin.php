...
Route::group([
    ...
    Route::group([
        ...
        Route::post('area/store', ['uses' => 'Area@importData', 'desc' => '导入数据'])->name('admin.tools.area.importData');
    ...
    Route::group([
        ...
        Route::manage(DevEngine\Core\Admin\Tools\Form::class)->only(['index', 'data', 'page', 'save', 'del'])->make();
        Route::get('form/setting/{id}', ['uses' => 'Form@setting', 'desc' => '设置'])->name('admin.tools.form.setting');
...
Route::group([
    ...
    Route::get('notification/read', ['uses' => 'Index@readNotify', 'desc' => '读取消息'])->name('admin.notification.read');
...
Route::group([
    ...
    Route::group([
        ...
        Route::post('setting/store', ['uses' => 'Setting@save', 'desc' => '保存设置'])->name('admin.system.setting.save');
    });
    /**
     * 系统用户
     */
    Route::group([
        ...
        Route::manage(DevEngine\Core\Admin\System\User::class)->only(['index', 'data', 'page', 'save', 'del'])->make();
    });
    /**
     * 系统角色
     */
    Route::group([
        ...
        Route::manage(DevEngine\Core\Admin\System\Role::class)->only(['index', 'data', 'page', 'save', 'del'])->make();
    });
    /**
     * 操作日志
     */
    ...
    Route::group([
        ...
        Route::get('application', ['uses' => 'Application@index', 'desc' => '列表'])->name('admin.system.application');
    });
    ...
    Route::group([
        ...
        Route::manage(DevEngine\Core\Admin\System\Api::class)->only(['index', 'data', 'page', 'save', 'del'])->make();
        Route::post('api/token/{id?}', ['uses' => 'Api@token', 'desc' => '更换TOKEN'])->name('admin.system.api.token');
    });
});
