...
class Form extends Expend
{

    public string $model = \DevEngine\Core\Model\Form::class;
    ...
    {
        $form = new \DevEngine\Core\UI\Form(new $this->model());
        $form->dialog(true);
    ...
    public function settingSave(int $id)
    {
        ...
        $model = new \DevEngine\Core\Model\Form();
