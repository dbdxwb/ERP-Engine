...
use DevEngine\Core\Manage\Operate;
use DevEngine\Core\UI\Table;
use DevEngine\Core\UI\Widget;

class VisitorOperate extends Expend
{

    public string $model = \DevEngine\Core\Model\VisitorOperate::class;
    ...
    protected function table(): Table
    {
        ...
        $table = new \DevEngine\Core\UI\Table(new \DevEngine\Core\Model\VisitorOperate());
        $table->title('操作日志');
    ...
    {
        $info = \DevEngine\Core\Model\VisitorOperate::find($id);
