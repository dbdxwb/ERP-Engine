...
use DevEngine\Core\Facades\Permission;
use DevEngine\Core\Model\Role as AuthRole;
use DevEngine\Core\UI\Form;
use DevEngine\Core\UI\Table;

class Role extends Expend
{

    use \DevEngine\Core\Manage\Role;
    ...
    {
        $parsing = app_parsing();
        $this->config['layer'] = strtolower($parsing['layer']);
