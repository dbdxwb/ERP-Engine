<template>
    <a-layout class="layout">
        <div class="layout-navbar">
            <NavBar :navbar="navbar" :menu="menu" :active_navbar="active_navbar" :currentIndexs="currentIndexs"/>
        </div>
        <a-layout>
            <a-layout>
                <a-layout-sider
                    ...
                    :breakpoint="'xl'"
                    :collapsible="true"
                    :style="{ paddingTop: '60px',width: '14rem' }"
                    :hide-trigger="true"
                >
                        ...
                        <div class="flex flex-row h-screen overflow-hidden">
                            <div class="
                                ...
                                <c-scrollbar class="flex-grow" trigger="hover">
                                    <div
                                        v-show="item.navbar===active_navbar&&(!item.hidden || currentIndexs[0] === index)"
                ...
                <a-layout class="layout-content">
                    <a-layout-content style=" margin-top: 60px;margin-left: 14rem;">
        ...
        menuHover(menu = this.menu, indexs = [], url = this.currentUrl) {
            return menu.findIndex((item, index) => {
                if (item.menu && item.menu.length > 0) {
                    ...
                    if (item.navbar !== undefined) {
                        this.active_navbar = item.navbar;
                    }
                    return true;
                }
            });
