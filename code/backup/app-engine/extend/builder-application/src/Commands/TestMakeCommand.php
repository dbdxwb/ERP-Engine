...
class TestMakeCommand extends GeneratorCommand
{
    ...
    protected $name = 'builder-application:make-test';
    protected $description = '为指定的模块创建新的测试类.';

    public function getDefaultNamespace() : string
    {
        return $this->laravel['builder-application']->config('paths.generator.test.path', 'Tests');
    }
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, '表单请求类的名称.'],
