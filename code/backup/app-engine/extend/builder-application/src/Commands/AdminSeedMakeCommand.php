...
class AdminSeedMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'builder-application:make-admin-seed';
    ...
    {
        return [
            ['master', null, InputOption::VALUE_NONE, '指示将创建的种子程序是主数据库种子程序.'],
        ];
    }
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub('/seeder-admin.stub', [
