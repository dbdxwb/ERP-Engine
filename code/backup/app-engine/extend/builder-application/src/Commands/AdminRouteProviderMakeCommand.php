...
class AdminRouteProviderMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'builder-application:admin-route-provider';
     ...
     * @var string
     */
    protected $description = '为指定的模块创建新的管理后台路由服务提供程序。';
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub('/route-provider-admin.stub', [
