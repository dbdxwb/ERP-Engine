...
use Builder\Application\Exceptions\InvalidAssetPath;
use Builder\Application\Exceptions\ModuleNotFoundException;
use Builder\Application\Process\Installer;
use Builder\Application\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
    ...
    {
        return $this->path ?: $this->config('paths.source', base_path('Source'));
    }
    ...
    public function findOrFail($name)
    {
        ...
        throw new ModuleNotFoundException("应用源码模块 [{$name}] 不存在!");
    }
    ...
    {
        return $this->app['config']->get('builder-application.' . $key, $default);
    }
     ...
     * @return string
     * @throws \Builder\Application\Exceptions\ModuleNotFoundException
     */
