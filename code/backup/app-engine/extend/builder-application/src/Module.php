...
abstract class Module extends ServiceProvider
{
    ...
    {
        if (config('builder-application.register.translations', true) === true) {
    ...
    {
        return config('builder-application.register.files', 'register') === 'boot' &&
            // force register method if option == boot && app is AsgardCms
            !class_exists('\Source\Core\Foundation\AsgardCms');
    }
}
